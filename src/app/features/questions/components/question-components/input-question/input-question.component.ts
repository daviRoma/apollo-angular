...
export class InputQuestionComponent implements OnInit, OnDestroy {
  ...
  editQuestion(): void {
    ...
    this.editDialogConf.data.dialogConfig.title = this.transalte.instant(
      'question.edit'
    );
  ...
  deleteQuestion(): void {
    ...
    this.deleteDilogConf.data.dialogConfig.title = this.transalte.instant(
      'question.delete'
    );
    this.deleteDilogConf.data.dialogConfig.content = this.transalte.instant(
